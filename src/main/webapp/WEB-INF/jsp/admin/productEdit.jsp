	...
	<body style="margin: auto;">
		...
		<div class="col-xs-10">
			<div class="bg-primary">
				<p style="text-align: center;">编辑商品</p>
			</div>
			
			<s:form id="productForm" action="adminProduct_update" enctype="multipart/form-data">
				...
				<table class="table">
					...
					<tr>
						...
						<td>所属二级分类</td>
						<td>
							<s:select list="%{csList}" listKey="id" listValue="name" name="secondCategory.id"></s:select>		
						</td>
					</tr>
					<tr>
						<td>商品描述</td>
